...
#define CONFIG_ENV_OFFSET      25165824
...
/* yuanjun : if use MMC, turn off this, and modify common/Makefile */
#if 1
...
/* yuanjun : turn on this for NET, ping, tftp etc */
#if 1
...
#define CONFIG_IPADDR          192.168.6.36
#define CONFIG_SERVERIP        192.168.6.89
