...
************************************************************************************************************
*/
uint sprite_display_cfg_get(void)
{
	if(!script_parser_fetch("card_boot", "sprite_no_display", &cfg_no_display, 1))
	{
	printf("detect sprite_no_display = %d!\n",cfg_no_display);
	return cfg_no_display;
	}
	cfg_no_display = 0;
	return cfg_no_display;
}
